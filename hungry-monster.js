...
const renderFoodInfo = food => {
    ...
    <ul class="list-unstyled mb-0">
        ...
        <li><i class="icon-check icons"></i> ${food.strIngredient6}</li>
        <li><i class="icon-check icons"></i> ${food.strIngredient7}</li>
        <li><i class="icon-check icons"></i> ${food.strIngredient8}</li>
    </ul>
`;
};
